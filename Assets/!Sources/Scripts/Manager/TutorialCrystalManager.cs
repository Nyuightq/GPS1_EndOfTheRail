// This file is created exactly same as RewardManager.cs
using System.Collections;
using System.Collections.Generic;
using UnityEngine;
using TMPro;

public class TutorialCrystalManager : MonoBehaviour
{
    public static TutorialCrystalManager Instance;
    ...
    public delegate void OnCloseEvent(bool value);
    public event OnCloseEvent onCloseEvent;
